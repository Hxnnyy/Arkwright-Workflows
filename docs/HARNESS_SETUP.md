...
2. Register each skill directory in your harness skill system.
3. Ensure shared files remain reachable at skills/_shared.
4. Use longflow.config.json to control model and routing policy.
...
- If your harness does not support named agents, use prompt templates in examples/prompts and run role-equivalent generic subagent tasks.
...
- Config file validates using scripts/validate-config.mjs.
- You can generate a kickoff prompt using scripts/generate-kickoff-prompt.mjs.
