...
Each child issue must have a deterministic acceptance predicate script.

A child issue cannot close unless its predicate script exits successfully on the integration branch.
...
Implementation agents receive predicate scripts as contracts and must not modify them.
