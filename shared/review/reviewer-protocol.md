...
Use the same reviewer thread for that one correction when possible. Once a valid or final malformed verdict is stored, mark the result consumed and close the reviewer per `../orchestration/agent-lifecycle.md`.
