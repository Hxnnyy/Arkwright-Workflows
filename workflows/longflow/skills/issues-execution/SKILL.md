...
- ../../../../shared/templates/STATE.json
- ../../../../shared/templates/EXECPLAN.md
...
3. Child issue closes only after predicate pass, test evidence, and no-blocking reviewer verdict.
4. Implementers do not modify predicate scripts without amber governance approval.
5. Predicate pass is an evidence floor, not a quality ceiling.
6. Delegate implementation by default.
7. Keep orchestrator edits tiny and low-risk.
8. No parent closure without required final audits.
...
Write directive, state, execplan, and heartbeat files.
...
4. run predicate and relevant tests
5. run predicate adequacy, test adequacy, and required issue reviewers
...
All required final persona-model audits are PASS or NOT_APPLICABLE with blocking_count = 0. PASS_WITH_NOTES is not sufficient at final closeout unless config explicitly permits it and residual risk is accepted through governance.
